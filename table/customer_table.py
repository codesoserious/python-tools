...
def print_schedule():
    print('======================================')
    print('Job1-startTime:%s' % (datetime.now().strftime('%Y-%m-%d %H:%M:%S')))
    print('-------每隔五秒执行一次------')
    print('Job1-endTime:%s' % (datetime.now().strftime('%Y-%m-%d %H:%M:%S')))
    print('                                        ')


if __name__ == "__main__":
    schedule.every(30).seconds.do(print_schedule)
    while True:
